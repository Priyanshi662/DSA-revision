...
class Solution {
public:
// intuition - when we swap the first non decreasing element with the element just greater than it present after its position then we get the next greater element
